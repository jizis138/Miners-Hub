...
fun main() {
    ...
    val name = "settings" // todo: поменяй это на название модуля.
    ...
    val apiPackage = "ru.vsibi.momento.${codePackagePrefix}_api"
    val implPackage = "ru.vsibi.momento.${codePackagePrefix}_impl"
